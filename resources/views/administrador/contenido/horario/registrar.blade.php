								...
								<div class="form-row">
									<div class="col">
										<div class="md-form mb-1">
											...
											<select name='laboratorio_id' id="horarioRegisterFormIdLab" class="form-control" aria-describedby="horarioRegisterFormIdLabHelpBlock">
									...
									<div class="col">
										<div class="md-form mb-1">
											<label for="horarioRegisterFormIdLab">Materia</label><br><br>
											<select name='materia_id' id="horarioRegisterFormIdLab" class="form-control" aria-describedby="horarioRegisterFormIdLabHelpBlock">
											  <option value="null">Seleccione materia</option>
