...
@section('navegacion')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb p-0 m-0 pl-5">
            ...
            <li class="breadcrumb-item active" href="/home">Crear Producto</li>
        </ol>
    </nav>
@endsection
    ...
    <div class="card">
        ...
        <div class="d-flex justify-content-center p-2">
            <div class="w-75">
                ...
                <form action="{{ route('productos.store') }}" method="POST" enctype="multipart/form-data" class="text-center" style="color: #757575;">
                    {{ csrf_field() }}
                    <div class="form-row">
                        <div class="col">
                            <div class="md-form mb-1">
                                <input type="text" readonly="readonly" id="materialRegisterFormSesiones" class="form-control" aria-describedby="materialRegisterFormSesioneHelpBlock" name='sesione_id' value="{{$sesione->id}}" required>
