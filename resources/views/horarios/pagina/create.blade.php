...
@section('navegacion')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb p-0 m-0 pl-5">
            ...
            <li class="breadcrumb-item active" href="/home">Crear Horario</li>
        </ol>
    </nav>
@endsection
    ...
    <div class="card">
        ...
        <div class="d-flex justify-content-center p-2">
            <div class="w-75">
                ...
                <form action="{{ route('horarios.store') }}" method="POST" class="text-center" style="color: #757575;">
                    {{ csrf_field() }}
                    <div class="form-row">
                        <div class="col">
                            <div class="">
                                <label for="formGroupExampleInput">Dia</label>
                        ...
                        <div class="col">
                            ...
                            <select class="custom-select" id="materia_id" name="materia_id">
                                @foreach ($materias as $materia)
                                    <option value="{{$materia->id}}">{{$materia->nameM}} - {{$materia->grupo}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
