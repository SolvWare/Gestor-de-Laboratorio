<div class="">
    <div class="card">
        ...
        <div class="d-flex justify-content-center p-2">
            ...
            <form action="{{ route('inscripcion.update',$inscripcion->id) }}" method="POST" class="text-center" style="color: #757575;">
                    {{ csrf_field() }}
                    {{ @method_field('PUT') }}
                    ...
                    <div class="form-row">
                        <div class="col">
                            <div class="md-form mb-1">
                                <input maxlength="20" type="text" id="materialRegisterFormCode" class="form-control" aria-describedby="materialRegisterFormCodeHelpBlock" name='materia' value="{{$inscripcion->materia}}">
                                <label for="materialRegisterFormCode">Materia</label>
                            </div>
                        </div>
                        <div class="col">
                            <div class="md-form mb-1">
                                <input maxlength="20" type="text" id="materialRegisterFormCode" class="form-control" aria-describedby="materialRegisterFormCodeHelpBlock" name='laboratorio' value="{{$inscripcion->laboratorio}}">
