...
<html lang="en">
    ...
    <body class="h-100">
        ...
        <header class="h-25">
            @include('administrador.pagina.nav')
        </header>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb p-0 m-0 pl-5">
                <li class="breadcrumb-item"><a class="black-text" href="/admi">Home</a></li>
                <li class="breadcrumb-item"><a class="black-text" href="/materia">Lista</a></li>
            </ol>
        </nav>
        <section class="d-flex text-white h-75 mt-1">
            <div class="w-25 d-inline-block">
                @include('auxiliar.contenido.menu')
            </div>
            <div class="w-100 d-inline-block mr-1 ml-1">
                @include('auxiliar.contenido.ControlPracticas.ListaControles')
            </div>
            <div class="w-25 d-inline-block">
                @include('inicio.link')
            </div>
