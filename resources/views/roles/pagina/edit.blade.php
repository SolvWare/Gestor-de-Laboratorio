...
@section('navegacion')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb p-0 m-0 pl-5">
            ...
            <li class="breadcrumb-item active" href="/home">Editar Rol</li>
        </ol>
    </nav>
@endsection
...
<div class="">
    <div class="card">
        ...
        <div class="w-75">
            ...
            <form action="{{ route('roles.update', $role->id) }}" method="POST" class="text-center" style="color: #757575;">
                {{ csrf_field() }}
                {{ @method_field('PUT') }}
                <div class="form-row">
                    <div class="col">
                    ...
                    <div class="col">
                        <div class="md-form mb-1">
                            <input maxlength="30" type="text" id="materialRegisterFormSlug" class="form-control" aria-describedby="materialRegisterFormSlugHelpBlock" name="slug" value="{{$role->slug}}" required>
                ...
                <div class="form-row">
                    ...
                    <div class="col p-2 ml-5">
                        ...
                        <div class="custom-control custom-checkbox d-flex flex-row">
                            ...
                            <label class="custom-control-label" for="customCheck2">Ver Ningún acceso</label>
                        </div>
                    </div>
                </div>
