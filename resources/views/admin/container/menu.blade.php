            ...
            <div class="">
                ...
                <div id="collapseOne" class="collapse" role="tabpanel" aria-labelledby="headingOne">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item "><a href="/rol" class="text-dark">Listar Editar Deshabilitar</a></li>
                    </ul>
                </div>
            </div>
            <div class="card">
                ...
                <div id="collapseTwo" class="collapse" role="tabpanel" aria-labelledby="headingTwo">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item "><a href="/materia" class="text-dark">Listar Editar Deshabilitar</a></li>
                    </ul>
                </div>
            </div>
            <div class="card">
